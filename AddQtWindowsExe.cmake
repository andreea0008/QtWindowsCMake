...
function(add_qt_windows_exe TARGET)
  ...
  message(STATUS "SETTINGS_FILE PATH argwin  : ${QML_DIR}")
  ...
  if(ARGWIN_VERBOSE_LEVEL_DEPLOY)
    ...
    if(NOT ARGWIN_NO_DEPLOY)
      ...
      add_custom_target(${QT_WINDOWS_APP_DEPLOY_NAME}
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_if_different "C:/Users/andre/Desktop/lynx_work/TelmioApp/TelmioApp/resources/settings.ini" $<TARGET_FILE_DIR:${TARGET}>/settings.ini
